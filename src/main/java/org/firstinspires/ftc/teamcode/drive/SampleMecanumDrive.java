...
//    public static PIDCoefficients HEADING_PID = new PIDCoefficients(1, 0, 0);
    ...
    public static double LATERAL_MULTIPLIER = 1.318126133291159;
...
//        setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap));
    ...
    private void se_ridica_din_mormant(double dist) {
        brat.setPower(0);
        int target = brat.getCurrentPosition() - (int) (dist * counts_per_inch);
        brat.setTargetPosition(target);
        brat.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        setPowerBrat(POWER_BRAT);
    ...
    public void puneCub() throws InterruptedException {
        cuva.setPosition(POZITIE_ARUNCA_CUVA);
        sleep(1000);
        cuva.setPosition(POZITIE_NORMAL_CUVA);
    }

    public void invarteRata() throws InterruptedException {
    ...
    public void setGhearaPower(double power){

...
//  public static Vector2d la_hub = new Vector2d(-5.504788048944423, -47.50714739102929);
    ...
    public static Pose2d la_hub_pose3 = new Pose2d(-10.304788048944423, -45.90714739102929, Math.toRadians(90));
    ...
    public static Pose2d la_hub_pose2BLUE = new Pose2d(-10.804788048944423, 45.90714739102929, Math.toRadians(-90));
    public static Pose2d la_hub_pose3BLUE = new Pose2d(-11.804788048944423, 45.90714739102929, Math.toRadians(-90));
    public static Vector2d la_rata_vectorBLUE = new Vector2d(-60.20714739102929, 58.570714739102929);
    public static Pose2d back_to_initialBLUE = new Pose2d(12.004788048944423, 68.7000000, Math.toRadians(-179));
    public static Pose2d back_to_initial2BLUE = new Pose2d(12.004788048944423, 68.9999000, Math.toRadians(-179));
    ...
    public static Pose2d park_poseBLUE = new Pose2d(45, 69.2, Math.toRadians(-180));

//    BLUE DR
    public static Pose2d initialBLUEDR = new Pose2d(-36.02923842281328, 64.30714739102929, Math.toRadians(-90));
    public static Vector2d la_hubBLUEDR = new Vector2d(-10.804788048944423, 45.30714739102929);
    public static Vector2d la_hubBLUEDR_reven = new Vector2d(-10.804788048944423, 54.30714739102929);
    public static Pose2d back_to_initialBLUEDR = new Pose2d(11.004788048944423, 68.2000000, Math.toRadians(-179));
    public static Pose2d back_to_initialBLUEDR2 = new Pose2d(11.004788048944423, 68.7000000, Math.toRadians(-179));
    public static Pose2d la_hub_pose2BLUEDR2 = new Pose2d(-12.304788048944423, 44.90714739102929, Math.toRadians(-90));
    public static Vector2d la_hub_simple_part1BLUE = new Vector2d(-60.20714739102929, 30);
    public static Pose2d la_hub_simple_part2BLUE = new Pose2d(-30.20714739102929, 24, Math.toRadians(0));
    public static Pose2d park_mai_putin_csfBLUE = new Pose2d(-59, 35, Math.toRadians(0));
